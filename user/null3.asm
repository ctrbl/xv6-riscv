...
user/_null3:     file format elf64-littleriscv
...
strcpy(char *s, const char *t)
{
  ...
  while((*s++ = *t++) != 0)
    ...
    305e:	fff5c703          	lbu	a4,-1(a1) # 1fff <main-0x1001>
    3062:	fee78fa3          	sb	a4,-1(a5) # 1fff <main-0x1001>
